...
public class ShoppingCartFragment extends Fragment implements View.OnClickListener {
    ...
    Map<Productentity, Integer> mapProduct = new HashMap<>();
    ...
    private void productFound(List<Productentity> productList) {
        if(productList == null)
    ...
    private List<Cart> getCartItems(){
        for(Map.Entry<Productentity,Integer> productIntegerMap : mapProduct.entrySet()){
    ...
    private void createHashmap(List<Productentity> product) {
        for (Productentity presentProd : productList) {
